ALTER TABLE `sales_documents`
  ...
  ADD COLUMN `fiscal_use` CHAR(32) NOT NULL DEFAULT 'G03' AFTER `payment_type`;
...
ALTER TABLE `quotes_documents` DROP KEY `code`;
ALTER TABLE `quotes_documents` ADD UNIQUE KEY (`company_id`, `code`);

ALTER TABLE `sales_documents` DROP KEY `code`;
ALTER TABLE `sales_documents` ADD UNIQUE KEY (`company_id`, `code`);

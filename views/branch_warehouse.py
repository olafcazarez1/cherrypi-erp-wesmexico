...
class vBranchWarehouse(Model):
    """Database table name"""

    _TABLE = "v_branch_offices_warehouses"
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(vBranchWarehouse)
    ...
    def __repr__(self):
        ...
        """
        return f"vBranchWarehouse('{self.branch_id}_{self.warehouse_id}')"

...
class EmployeeProduct(Model):
    """Database table"""

    _TABLE = "employees_products"

    """Database primary keys
    """
    _IDS = ["employee_id", "product_id", "measure_id"]
    ...
    """
    _REQUIRED = ["employee_id", "product_id", "measure_id", "quantity"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(EmployeeProduct)
    ...
    def __repr__(self):
        ...
        """
        return f"EmployeeProduct('{self.employee_id}')"

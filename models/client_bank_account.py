...
class ClientBankAccount(Model):
    """Database table name"""

    _TABLE = "clients_bank_accounts"
    ...
    """
    _REQUIRED = ["client_id", "bank_account_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ClientBankAccount)
    ...
    def __repr__(self):
        ...
        """
        return f"ClientBankAccount('{self.client_id}')"

...
class StockInOutProductTax(Model):
    """Database table name"""

    _TABLE = "stocks_io_products_taxes"

    """Database primary keys
    """
    _IDS = ["stock_io_id", "product_id", "tax_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(StockInOutProductTax)
    ...
    def __repr__(self):
        ...
        """
        return f"StockInOutProductTax('{self.stock_io_id}')"

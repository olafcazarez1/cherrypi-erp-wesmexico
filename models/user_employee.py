...
class UserEmployee(Model):
    """Database table name"""

    _TABLE = "users_employees"

    """Database primary keys
    """
    _IDS = ["user_id", "employee_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(UserEmployee)
    ...
    def __repr__(self):
        ...
        """
        return f"UserEmployee('{self.user_id}')"

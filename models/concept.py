...
class Concept(Model):
    ...
    """
    _REQUIRED = ["concept_id", "division_id", "subdivision_id", "code", "name", "status"]
    ...
    def subdivision_id(self, subdivision_id):
        """Setter subdivision_id

        Args:
            subdivision_id(string): id.
        ...
        """
        self.__subdivision_id = subdivision_id
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(Concept)

...
class ProductUnitAssignment(Model):
    """Database table"""

    _TABLE = "products_units_assignments"
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductUnitAssignment)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductUnitAssignment('{self.assignment_id}')"

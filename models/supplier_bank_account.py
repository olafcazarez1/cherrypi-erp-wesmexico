...
class SupplierBankAccount(Model):
    ...
    _TABLE = "suppliers_bank_accounts"
    ...
    """
    _REQUIRED = ["supplier_id", "bank_account_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(SupplierBankAccount)
    ...
    def __repr__(self):
        ...
        """
        return f"SupplierBankAccount('{self.supplier_id}')"

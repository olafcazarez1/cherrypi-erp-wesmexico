...
class EmployeeBankAccount(Model):
    """Database table name"""

    _TABLE = "employees_bank_accounts"
    ...
    """
    _REQUIRED = ["employee_id", "bank_account_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(EmployeeBankAccount)
    ...
    def __repr__(self):
        ...
        """
        return f"EmployeeBankAccount('{self.employee_id}')"

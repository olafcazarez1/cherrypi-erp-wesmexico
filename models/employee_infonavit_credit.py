...
class EmployeeInfonavitCredit(Model):
    """Database table"""

    _TABLE = "employees_infonavit_credits"
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(EmployeeInfonavitCredit)
    ...
    def __repr__(self):
        ...
        """
        return f"EmployeeInfonavitCredit('{self.employee_id}')"

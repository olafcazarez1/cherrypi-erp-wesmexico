...
class ProductAssignmentItem(Model):
    """Database table name"""

    _TABLE = "products_assignments_items"

    """Database primary keys
    """
    _IDS = ["assignment_id", "product_id", "measure_id"]
    ...
    """
    _REQUIRED = ["assignment_id", "product_id", "measure_id", "quantity", "type"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductAssignmentItem)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductAssignmentItem('{self.assignment_id}')"

...
class SaleDocumentProduct(Model):
    """Database table name"""

    _TABLE = "sales_documents_details"

    """Database primary keys
    """
    _IDS = ["document_id", "product_id", "measure_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(SaleDocumentProduct)
    ...
    def __repr__(self):
        ...
        """
        return f"SaleDocumentProduct('{self.document_id}')"

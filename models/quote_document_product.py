...
class QuoteDocumentProduct(Model):
    """Database table name"""

    _TABLE = "quotes_documents_details"

    """Database primary keys
    """
    _IDS = ["quote_id", "product_id", "measure_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(QuoteDocumentProduct)
    ...
    def __repr__(self):
        ...
        """
        return f"QuoteDocumentProduct('{self.quote_id}')"

...
class ProductRelated(Model):
    ...
    _TABLE = "products_related"

    """Database primary keys
    """
    _IDS = ["product_id", "item_id", "measure_id"]
    ...
    """
    _REQUIRED = ["product_id", "item_id", "measure_id", "quantity", "status"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductRelated)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductRelated('{self.measure_id}')"

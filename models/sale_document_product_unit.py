...
class SaleDocumentProductUnit(Model):
    """Database table name"""

    _TABLE = "sales_documents_products_units"

    """Database primary keys
    """
    _IDS = ["document_id", "product_id", "unit_id"]
    ...
    """
    _REQUIRED = ["document_id", "product_id", "measure_id", "unit_id", "uid"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(SaleDocumentProductUnit)
    ...
    def __repr__(self):
        ...
        """
        return f"SaleDocumentProductUnit('{self.document_id}')"

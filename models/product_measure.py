...
class ProductMeasure(Model):
    """Database table name"""

    _TABLE = "products_measures"
    ...
    """
    _REQUIRED = ["product_id", "measure_id", "external_reference", "equivalence" "default", "status"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductMeasure)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductMeasure('{self.measure_id}')"

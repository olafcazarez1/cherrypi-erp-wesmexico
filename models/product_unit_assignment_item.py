...
class ProductUnitAssignmentItem(Model):
    """Database table"""

    _TABLE = "products_units_assignments_details"

    """Database primary keys
    """
    _IDS = ["assignment_id", "product_id", "unit_id"]
    ...
    """
    _REQUIRED = ["assignment_id", "product_id", "unit_id", "type"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductUnitAssignmentItem)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductUnitAssignmentItem('{self.assignment_id}')"

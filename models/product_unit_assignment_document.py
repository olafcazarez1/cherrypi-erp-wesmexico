...
class ProductUnitAssignmentDocument(Model):
    """Database table name"""

    _TABLE = "products_units_assignments_documents"
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductUnitAssignmentDocument)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductUnitAssignmentDocument('{self.document_id}')"

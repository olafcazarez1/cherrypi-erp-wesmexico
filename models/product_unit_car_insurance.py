...
class ProductUnitCarInsurance(Model):
    """Database table"""

    _TABLE = "products_units_cars_insurances"
    ...
    """
    _REQUIRED = ["product_id", "unit_id", "folio", "agency", "total", "document", "expedition_date", "expiration_date"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(ProductUnitCarInsurance)
    ...
    def __repr__(self):
        ...
        """
        return f"ProductUnitCarInsurance('{self.unit_id}')"

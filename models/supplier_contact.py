...
class SupplierContact(Model):
    """Database table name"""

    _TABLE = "suppliers_contacts"

    """Database primary keys
    """
    _IDS = ["supplier_id", "contact_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(SupplierContact)
    ...
    def __repr__(self):
        ...
        """
        return f"SupplierContact('{self.supplier_id}')"

...
class InvoiceDocumentProductTax(Model):
    """Database table name"""

    _TABLE = "invoiced_documents_products_taxes"

    """Database primary keys
    """
    _IDS = ["invoice_id", "product_id", "tax_id"]
    ...
    def get_attrs(self):
        ...
        """
        return super().get_attrs(InvoiceDocumentProductTax)
    ...
    def __repr__(self):
        ...
        """
        return f"InvoiceDocumentProductTax('{self.invoice_id}')"
